...
const DeviceVariables = {
  ...
  pivot_auth_header: 'THIS SHOULD BE CHANGED',
  user_image: 'THIS SHOULD BE CHANGED',
  return_calendar: 'THIS SHOULD BE CHANGED',
  return_chat: 'THIS SHOULD BE CHANGED',
};
const AppVariables = {
  error_message: 'THIS SHOULD BE CHANGED',
  is_loading: 'THIS SHOULD BE CHANGED',
  whereby_header: 'THIS SHOULD BE CHANGED',
};
